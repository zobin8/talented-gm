...
**At least, that is what will be possible once it is programmed. At the moment, some features are missing.** The following features are not currently implemented:
 * NPC Descriptions (for custom abilities and the like)
 * Tracking NPC consciousness
 * Undo/Redo
